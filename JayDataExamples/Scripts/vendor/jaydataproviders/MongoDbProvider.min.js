...
(delete a.query[a.field],a.queryField="_id");c=a.value;a.entityType&&a.entityType.memberDefinitions?c=this.provider.fieldConverter.toDb[Container.resolveName(Container.resolveType(a.entityType.memberDefinitions.getMember(a.complexType?a.lastField:a.field).type))](c):a.valueType&&(c=this.provider.fieldConverter.toDb[Container.resolveName(Container.resolveType(a.valueType))](c));a.value=c;a.cursor instanceof Array?(e={},e[a.queryField]=a.unary===$data.Expressions.ExpressionType.Not?{$ne:a.value}:a.value,
a.cursor.push(e)):a.cursor[a.queryField]=a.unary===$data.Expressions.ExpressionType.Not?{$ne:a.value}:a.value;a.options&&a.options.fields&&(a.options.fields[a.queryField]=1);a.unary===$data.Expressions.ExpressionType.Not&&(a.unary=void 0);break;case $data.Expressions.ExpressionType.In:this.Visit(b.left,a);this.Visit(b.right,a);a.queryField=a.field;!a.complexType&&a.entityType&&a.entityType.memberDefinitions.getMember(a.field).computed&&(delete a.query[a.field],a.queryField="_id");c=a.value;if(c instanceof
Array){c=c.map(function(a){return a.value});for(d=0;d<c.length;d++)a.entityType&&a.entityType.memberDefinitions?c[d]=this.provider.fieldConverter.toDb[Container.resolveName(Container.resolveType(a.entityType.memberDefinitions.getMember(a.complexType?a.lastField:a.field).type))](c[d]):a.valueType&&(c[d]=this.provider.fieldConverter.toDb[Container.resolveName(Container.resolveType(a.valueType))](c[d]))}a.value=c;a.cursor instanceof Array?(e={},e[a.queryField]={},a.entityType&&a.entityType===$data.Array?
e[a.queryField]=a.unary===$data.Expressions.ExpressionType.Not?{$not:a.value}:a.value:e[a.queryField][a.unary===$data.Expressions.ExpressionType.Not?"$nin":b.resolution.mapTo]=a.value,a.cursor.push(e)):(a.cursor[a.queryField]={},a.entityType&&a.entityType===$data.Array?a.cursor[a.queryField]=a.unary===$data.Expressions.ExpressionType.Not?{$not:a.value}:a.value:a.cursor[a.queryField][a.unary===$data.Expressions.ExpressionType.Not?"$nin":b.resolution.mapTo]=a.value);a.options&&a.options.fields&&(a.options.fields[a.queryField]=
1);a.unary===$data.Expressions.ExpressionType.Not&&(a.unary=void 0);break;default:this.Visit(b.left,a);this.Visit(b.right,a);a.queryField=a.field;if(Array.isArray(a.cursor)&&a.cursor[0]&&a.cursor[0][a.queryField]&&(a.cursor[0][a.queryField].$near||a.cursor[0][a.queryField].$nearSphere||a.cursor[0][a.queryField].$within))a.query=a.cursor[0],a.cursor=a.cursor[0];if((d=a.cursor[0]||a.cursor)&&d[a.queryField]&&d[a.queryField].$within)break;!a.complexType&&a.entityType&&a.entityType.memberDefinitions.getMember(a.field).computed&&
(delete a.query[a.field],a.queryField="_id");c=a.value;a.entityType&&a.entityType.memberDefinitions?c=this.provider.fieldConverter.toDb[Container.resolveName(Container.resolveType(a.entityType.memberDefinitions.getMember(a.complexType?a.lastField:a.field).type))](c):a.valueType&&(c=this.provider.fieldConverter.toDb[Container.resolveName(Container.resolveType(a.valueType))](c));a.value=c;a.cursor instanceof Array?(e={},e[a.queryField]={},e[a.queryField][b.resolution.mapTo]=a.value,a.cursor.push(e)):
(a.cursor[a.queryField]={},a.cursor[a.queryField][b.resolution.mapTo]=a.value);a.options&&a.options.fields&&(a.options.fields[a.queryField]=1)}delete a.complexType;delete a.association;delete a.field;delete a.value},VisitEntityFieldExpression:function(b,a){this.Visit(b.source,a);this.Visit(b.selector,a)},VisitAssociationInfoExpression:function(b,a){this.includes=this.includes||[];for(var c=(a.include?a.include.name+"."+b.associationInfo.FromPropertyName:b.associationInfo.FromPropertyName).split("."),
d=null,e=this.mainEntitySet.entityContext._storageModel.getStorageModel(this.mainEntitySet.createNew),f=0;f<c.length;f++){d=d?d+("."+c[f]):c[f];if(e=e.Associations[c[f]]){var g=this.includes.filter(function(a){return a.name==d},this);a.include&&f<c.length-1&&(a.include.options.fields||(a.include.options.fields={_id:1}),a.include.options.fields[c[f+1]]=1);g.length?(a.includeOptions=g[0].options,a.include=g[0]):(g={name:d,type:e.ToType,from:e.FromType,query:{},options:{},mapped:!1},a.includeOptions=
g.options,a.include=g,a.include.options.fields={_id:1},a.include.options.fields[e.ToPropertyName]=1,this.includes.push(g));a.options.fields||(a.options.fields={_id:1});a.options.fields[c[0]]=1;e.ReferentialConstraint.forEach(function(b){for(var c in b)a.options.fields[b[c]]=1});a.full=!0;a.mainCursor=a.cursor;a.cursor=a.include.query;a.entityType=e.ToType}else Guard.raise(new Exception("The given include path is invalid: "+b.associationInfo.FromPropertyName+", invalid point: "+d));e=this.mainEntitySet.entityContext._storageModel.getStorageModel(e.ToType)}},
VisitMemberInfoExpression:function(b,a){a.field=a.complexType&&a.field?a.field+"."+b.memberName:b.memberName;a.complexType&&(a.lastField=b.memberName)},VisitComplexTypeExpression:function(b,a){a.complexType=!0;this.Visit(b.source,a);this.Visit(b.selector,a);a.entityType=b.entityType},VisitQueryParameterExpression:function(b,a){a.data+=this.provider.fieldConverter.toDb[b.type](b.value)},_fieldOperation:function(b,a){var c,d;switch(b){case "contains":c="$regex";d=a.value.replace(/([.?*+^$[\]\\(){}|-])/g,
"\\$1");break;case "startsWith":c="$regex";d="^"+a.value.replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1");break;case "endsWith":c="$regex",d=a.value.replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1")+"$"}return{opMapTo:c,opValue:d}},VisitEntityFieldOperationExpression:function(b,a){Guard.requireType("expression.operation",b.operation,$data.Expressions.MemberInfoExpression);this.Visit(b.source,a);var c=b.operation.memberDefinition,d=c.mapTo||c.name,e=0;(c.parameters||[{name:"@expression"}]).map(function(a){return"@expression"===
a.name?b.source:b.parameters[e++]}).forEach(function(b){this.Visit(b,a)},this);d=this._fieldOperation(d,a);c=d.opMapTo;d=d.opValue;a.unary===$data.Expressions.ExpressionType.Not&&(d="^((?!"+d+").)*$");a.options.fields&&(a.options.fields[a.field]=1);if(!a.include&&c&&d)if(a.cursor instanceof Array){var f={};f[a.field]={};f[a.field][c]=d;a.cursor.push(f)}else a.cursor[a.field]={},a.cursor[a.field][c]=d;a.complexType&&(delete a.complexType,delete a.field)},VisitConstantExpression:function(b,a){var c=
Container.resolveName(b.type);a.valueType=c;a.value=b.value;if((c=Array.isArray(a.cursor)?a.cursor.filter(function(b){return"undefined"!==typeof b[a.field]})[0]:a.cursor)&&c[a.field]&&c[a.field].$within)c=c[a.field],c.$within.$center?c.$within.$center=[c.$within.$center,a.value]:c.$within.$centerSphere&&(c.$within.$centerSphere=[c.$within.$centerSphere,a.value])},VisitEntityExpression:function(b,a){a.entityType=b.entityType;a.mainCursor&&(a.cursor=a.mainCursor,delete a.include);this.Visit(b.source,
a)},VisitEntitySetExpression:function(b,a){this.Visit(b.source,a);b.selector instanceof $data.Expressions.AssociationInfoExpression&&(this.Visit(b.selector,a),a.data+="/")},_frameOperation:function(b,a,c,d,e){for(var f=this,g=[],c=0;c<a.length;c++){var j=a[c];if(j&&j.value instanceof $data.Queryable){var i=new b.frameType(j.value.expression),i=(new $data.Expressions.QueryExpressionCreator(j.value.entityContext)).Visit(i),l=function(a,b,c){if(a._expressionType===$data.Expressions.AssociationInfoExpression){var c=
c+("."+a.associationInfo.FromPropertyName),d=b.entitySet.entityContext._storageModel.getStorageModel(b.defaultType).Associations[a.associationInfo.FromPropertyName];if(d){var i=b.includes.filter(function(a){return a.name==c},this);0==i.length&&(i={name:c,type:d.ToType,from:d.FromType,query:{},options:{},mapped:!1},i.options.fields={_id:1},i.options.fields[d.ToPropertyName]=1,b.includes.push(i));b.context.options.fields||(b.context.options.fields={_id:1});d.ReferentialConstraint.forEach(function(a){for(var b in a);
})}else Guard.raise(new Exception("The given include path is invalid: "+a.associationInfo.FromPropertyName+", invalid point: "+c));b.defaultType=d.ToType}else a._expressionType===$data.Expressions.FrameOperationExpression?g.push(function(){var d=a.operation.memberDefinition,e=0,g=(d.parameters||[{name:"@expression"}]).map(function(b){return"@expression"===b.name?a.source:a.parameters[e++]});f._frameOperation(d,g,a,{entitySet:j.value.entityContext._entitySetReferences[j.value.expression.elementType.name],
defaultType:j.value.expression.elementType,context:b.context,includes:f.includes},c)}):a._expressionType===$data.Expressions.MemberInfoExpression&&(c=e,b.defaultType=j.value.expression.elementType);a.source&&(c=l(a.source,b,c));a.selector&&(c=l(a.selector,b,c));a.expression&&(c=l(a.expression,b,c));a.left&&(c=l(a.left,b,c));a.right&&(c=l(a.right,b,c));return c};l(i,{entitySet:j.value.entityContext._entitySetReferences[j.value.expression.elementType.name],defaultType:j.value.expression.elementType,
context:d.context?d.context:d,includes:this.includes},e,0)}}g.forEach(function(a){a()})},VisitFrameOperationExpression:function(b,a){this.Visit(b.source,a);Guard.requireType("expression.operation",b.operation,$data.Expressions.MemberInfoExpression);var c=b.operation.memberDefinition,d=0,e=(c.parameters||[{name:"@expression"}]).map(function(a){return"@expression"===a.name?b.source:b.parameters[d++]});this._frameOperation(c,e,b,a,a.include.name)}});
...
a.context._entitySetReferences[c].tableOptions,function(e){e?b.error(e):i(d,a.context._entitySetReferences[c])}):i(d,a.context._entitySetReferences[c])}})})};a.providerConfiguration.username?d.authenticate(a.providerConfiguration.username,a.providerConfiguration.password||"",function(a,c){a?b.error(a):c&&e(a,d)}):e(c,d)}})},_connected:function(b,a,c,d,e){var f=!1;e.ReferentialConstraint.forEach(function(a){a[c]&&b[a[c]]&&d&&(f=JSON.stringify(b[a[c]])==JSON.stringify(d))});return f},_compile:function(b){return(new $data.storageProviders.mongoDB.mongoDBCompiler).compile(b)},
getTraceString:function(b){return this._compile(b)},executeQuery:function(b,a){var c=this,a=$data.typeSystem.createCallbackSetting(a),d=b.context.getEntitySetFromElementType(b.defaultType);this._compile(b);(new this.driver.Db(this.providerConfiguration.databaseName,this._getServer(),{safe:!1})).open(function(e,f){if(e)a.error(e);else{var g=new c.driver.Collection(f,d.tableName),j=b.includes&&b.includes.length?b.includes.map(function(a){delete a.options.fields;return{name:a.name,type:a.type,from:a.from,
collection:new c.driver.Collection(f,b.context.getEntitySetFromElementType(a.type).tableName),query:a.query||{},options:a.options||{}}}):null;b.context=c.context;var i=b.find,l=function(c,d){c?a.error(c):(b.find.filter&&(d=d.filter(b.find.filter)),b.rawDataList=b.expression.nodeType===$data.Expressions.ExpressionType.Count||b.expression.nodeType===$data.Expressions.ExpressionType.BatchDelete?d instanceof Array?[{cnt:d.length}]:[{cnt:d}]:d,a.success(b),f.close())},h=function(){switch(b.expression.nodeType){case $data.Expressions.ExpressionType.BatchDelete:g.remove(i.query,
{safe:!0},l);break;case $data.Expressions.ExpressionType.Count:if(!j||!j.length){g.find(i.query,i.options).count(l);break}default:i.full&&delete i.options.fields;var d=function(){g.find(i.query,i.options).toArray(function(b,d){if(b)a.error(b);else{var e=function(b){b.collection.find({},b.options).toArray(function(f,g){if(f)a.error(f);else{for(var i=b.name.split("."),h=i[i.length-1],k=c.context._storageModel.getStorageModel(b.from).Associations[h],u=function(a){if("0..1"==k.FromMultiplicity&&"*"==
k.ToMultiplicity){var b=g.filter(function(b){return c._connected(b,k.ToPropertyName,k.To,a._id,k)});a[h]=b}else"*"==k.FromMultiplicity&&"0..1"==k.ToMultiplicity?(b=g.filter(function(b){return null===a[k.FromPropertyName]?!1:c._connected(a,k.FromPropertyName,k.From,b._id,k)})[0],a[h]=b||a[h]):"1"==k.FromMultiplicity&&"0..1"==k.ToMultiplicity?(b=g.filter(function(b){return c._connected(b,k.ToPropertyName,k.To,a._id,k)})[0],a[h]=b||a[h]):"0..1"==k.FromMultiplicity&&"1"==k.ToMultiplicity&&(b=g.filter(function(b){return c._connected(a,
k.FromPropertyName,k.From,b._id,k)})[0],a[h]=b||a[h])},m=function(a,b){for(var c=!0,d=0;d<b.length;d++){"undefined"!==typeof a[b[d]]&&(a=a[b[d]]);if(Array.isArray(a)&&a.length)for(var c=!1,e=0;e<a.length;e++)d<b.length-1?m(a[e],b.slice(d)):u(a[e]);if(!c)break}c&&u(a)},q=0;q<d.length;q++)m(d[q],i.slice(0,-1));if(b.options.sort){i=Object.keys(b.options.sort);for(q=i.length-1;0<=q;q--){var o=new Function("it","return it."+i[q]+";");b.options.sort[i[q]]?d.sort(function(a,b){var c=o(a),d=o(b);return c===
d?0:c<d?1:-1}):result.sort(function(a,b){var c=o(a),d=o(b);return c===d?0:c>d?1:-1})}}j&&j.length?e(j.shift()):l(f,d)}})};j&&j.length?e(j.shift()):l(b,d)}})};b.withInlineCount?g.find(i.query,{}).count(function(c,f){e?a.error(e):(b.__count=f,d())}):d()}};c.providerConfiguration.username?f.authenticate(c.providerConfiguration.username,c.providerConfiguration.password,function(b,c){b?a.error(b):c?h():a.error("Authentication failed")}):h()}})},_typeFactory:function(b,a,c){if(a&&a.$ref&&a.$id||null==a||
void 0==a)return a;b=Container.resolveName(b);return c&&c[b]?c[b](a):new (Container.resolveType(b))(a)},_saveCollections:function(b,a){var c=this,d=0,e=this._getServer(),f=0,g=function(a){0>=--f&&a()},j=function(a,e,f){for(var g=[],j=0;j<e.insertAll.length;j++){for(var h=e.insertAll[j],p=Container.resolveType(h.type).memberDefinitions.getPublicMappedProperties(),n=0;n<p.length;n++){var k=p[n];if(k.concurrencyMode===$data.ConcurrencyMode.Fixed)h.data[k.name]=0;else if(k.computed)h.data._id=c._typeFactory(k.type,
h.data._id,c.fieldConverter.toDb);else if(Container.resolveType(k.type)===$data.Array&&k.elementType&&Container.resolveType(k.elementType)===$data.ObjectID){h.data[k.name]=c._typeFactory(k.type,h.data[k.name],c.fieldConverter.toDb);var s=h.data[k.name];if(s)for(var m=0;m<s.length;m++)s[m]=c._typeFactory(k.elementType,s[m],c.fieldConverter.toDb)}else h.data[k.name]=c._typeFactory(k.type,h.data[k.name],c.fieldConverter.toDb),h.data[k.name]&&h.data[k.name].initData&&(h.data[k.name]=h.data[k.name].initData)}g.push(h.data)}f.insert(g,
{safe:!0},function(g,j){if(g)b.error(g),a.close();else{for(var h=0;h<j.length;h++)for(var k=j[h],m=e.insertAll[h],v=Container.resolveType(m.type).memberDefinitions.getPublicMappedProperties(),t=0;t<v.length;t++){var n=v[t];n.inverseProperty||(m.entity[n.name]=c._typeFactory(n.type,k[n.computed?"_id":n.name],c.fieldConverter.fromDb))}d+=j.length;e.removeAll&&e.removeAll.length?l(a,e,f):e.updateAll&&e.updateAll.length?i(a,e,f):o(a,d)}})},i=function(a,e,j){f=e.updateAll.length;for(var h=0;h<e.updateAll.length;h++){for(var i=
e.updateAll[h],l={},p=Container.resolveType(i.type).memberDefinitions.getKeyProperties(),n=0;n<p.length;n++){var k=p[n];l[k.computed?"_id":k.name]=c.fieldConverter.toDb[Container.resolveName(Container.resolveType(k.type))](i.entity[k.name])}for(var s={},p=Container.resolveType(i.entity.getType()).memberDefinitions.getPublicMappedProperties().concat(Container.resolveType(i.physicalData.getType()).memberDefinitions.getPublicMappedProperties()),n=0;n<p.length;n++){var m=p[n];if(0<=i.entity.changedProperties.indexOf(m)||
i.physicalData.changedProperties&&0<=i.physicalData.changedProperties.indexOf(m))if(m.concurrencyMode===$data.ConcurrencyMode.Fixed)l[m.name]=c._typeFactory(m.type,i.data[m.name],c.fieldConverter.toDb),s.$inc||(s.$inc={}),s.$inc[m.name]=1;else if(!m.computed&&"undefined"!==typeof i.data[m.name])if(Container.resolveType(m.type)===$data.Array&&m.elementType&&Container.resolveType(m.elementType)===$data.ObjectID){s[m.name]=c._typeFactory(m.type,i.physicalData[m.name],c.fieldConverter.toDb);var q=s[m.name];
if(q)for(k=0;k<q.length;k++)q[k]=c._typeFactory(m.elementType,q[k],c.fieldConverter.toDb)}else s[m.name]=c._typeFactory(m.type,i.physicalData[m.name],c.fieldConverter.toDb)}(function(e){j.update(l,{$set:s},{safe:!0},function(i,h){if(i)b.error(i),a.close();else if(h){d++;for(var k=Container.resolveType(e.type).memberDefinitions.getPublicMappedProperties(),m=0;m<k.length;m++){var n=k[m];n.concurrencyMode===$data.ConcurrencyMode.Fixed&&e.entity[n.name]++}g(function(){o(a,d)})}else f--,j.find({_id:l._id},
{}).toArray(function(f,i){if(f)b.error(f);else{for(var h=i[0],j=Container.resolveType(e.type).memberDefinitions.getPublicMappedProperties(),k=0;k<j.length;k++){var l=j[k];e.entity[l.name]=c._typeFactory(l.type,h[l.computed?"_id":l.name],c.fieldConverter.fromDb)}g(function(){o(a,d)})}})})})(i)}},l=function(a,e,j){f=e.removeAll.length;for(var h=0;h<e.removeAll.length;h++){var l=e.removeAll[h],r;for(r in l.data)(void 0===l.data[r]||null===l.data[r])&&delete l.data[r];var p=Container.resolveType(l.type).memberDefinitions.getKeyProperties();
for(r=0;r<p.length;r++){var n=p[r];l.data[n.computed?"_id":n.name]=c.fieldConverter.toDb[Container.resolveName(Container.resolveType(n.type))](l.entity[n.name])}p=Container.resolveType(l.type).memberDefinitions.getPublicMappedProperties();for(r=0;r<p.length;r++)n=p[r],n.key||delete l.data[n.name];j.remove(l.data,{safe:!0},function(c,h){c?(b.error(c),a.close()):(h?d++:f--,g(function(){e.updateAll&&e.updateAll.length?i(a,e,j):o(a,d)}))})}},h=Object.keys(a),o=function(d,e){if(h.length){var f=h.pop();
if(a.hasOwnProperty(f)){var g=a[f],f=new c.driver.Collection(d,f);g.insertAll&&g.insertAll.length?j(d,g,f):g.removeAll&&g.removeAll.length?l(d,g,f):g.updateAll&&g.updateAll.length?i(d,g,f):(b.success(0),d.close())}}else b.success(e),d.close()};(new this.driver.Db(this.providerConfiguration.databaseName,e,{safe:!1})).open(function(a,d){a?b.error(a):c.providerConfiguration.username?d.authenticate(c.providerConfiguration.username,c.providerConfiguration.password,function(a,c){a?b.error(a):c&&o(d)}):
o(d)})},saveChanges:function(b,a){var c=this;if(a.length){var d=this.buildIndependentBlocks(a),e=[],f=0,g=function(a){for(var i={},l=0;l<a.length;l++){e.push(a[l].data);var h=i[a[l].entitySet.name];h||(h={},i[a[l].entitySet.name]=h);var o={entity:a[l].data,data:c.save_getInitData(a[l],e),physicalData:a[l].physicalData,type:Container.resolveName(a[l].data.getType())};switch(a[l].data.entityState){case $data.EntityState.Unchanged:continue;case $data.EntityState.Added:h.insertAll||(h.insertAll=[]);h.insertAll.push(o);
break;case $data.EntityState.Modified:h.updateAll||(h.updateAll=[]);h.updateAll.push(o);break;case $data.EntityState.Deleted:h.removeAll||(h.removeAll=[]);h.removeAll.push(o);break;default:Guard.raise(new Exception("Not supported Entity state"))}}c._saveCollections({success:function(a){f+=a;d.length?g(d.shift()):b.success(f)},error:b.error},i)};d.length&&g(d.shift())}else b.success(0)},buildDbType_generateConvertToFunction:function(b){var a=this;return function(c){var d=new b.PhysicalType;d.entityState=
c.entityState;b.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){d.initData[a.name]=c[a.name]},this);b.Associations&&b.Associations.forEach(function(b){if("*"==b.FromMultiplicity&&"0..1"==b.ToMultiplicity||"0..1"==b.FromMultiplicity&&"1"==b.ToMultiplicity){var f=c[b.FromPropertyName];void 0!==f&&b.ReferentialConstraint.forEach(function(c){null!==f?(d.initData[b.FromPropertyName]={$ref:a._entitySetReferences[b.To].tableName,$id:a.storageProvider._typeFactory(f.getType().memberDefinitions.getMember(c[b.To]).type,
f[c[b.To]],a.storageProvider.fieldConverter.toDb)},d.initData[c[b.From]]=a.storageProvider._typeFactory(f.getType().memberDefinitions.getMember(c[b.To]).type,f[c[b.To]],a.storageProvider.fieldConverter.toDb)):(d.initData[b.FromPropertyName]=null,d.initData[c[b.From]]=null);d._setPropertyChanged(d.getType().memberDefinitions.getMember(c[b.From]))},this)}},this);b.ComplexTypes&&b.ComplexTypes.forEach(function(b){d.initData[b.FromPropertyName]=a.storageProvider._typeFactory(b.ToType,c[b.FromPropertyName],
a.storageProvider.fieldConverter.toDb)},this);return d}},buildDbType_modifyInstanceDefinition:function(b,a){var c=function(a,b,c,g){var j={};j[a.name]=c;j[b.name]=g+"__"+c;return j};a.Associations&&a.Associations.forEach(function(a){var e=!1,f=a.FromType,g=a.ToType,j=a.ToPropertyName;a.ReferentialConstraint=a.ReferentialConstraint||[];if("*"==a.FromMultiplicity&&"0..1"==a.ToMultiplicity||"0..1"==a.FromMultiplicity&&"1"==a.ToMultiplicity)f=a.ToType,g=a.FromType,j=a.FromPropertyName,e=!0;f.memberDefinitions.getPublicMappedProperties().filter(function(a){return a.key}).forEach(function(i){if(e){var l=
j+"__"+i.name,h;j?(h=JSON.parse(JSON.stringify(b[j])),h.kind=i.kind,h.name=i.name,h.notMapped=!1):h=JSON.parse(JSON.stringify(i));h.dataType=Container.resolveType(i.dataType);h.type=h.dataType;h.key=!1;h.computed=!1;b[l]=h}a.ReferentialConstraint.push(c(f,g,i.name,j))},this)},this)},save_getInitData:function(b,a){b.physicalData=this.context._storageModel.getStorageModel(b.data.getType()).PhysicalType.convertTo(b.data,a);var c={};b.physicalData.getType().memberDefinitions.asArray().forEach(function(a){if(a.kind==
$data.MemberTypes.navProperty||a.kind==$data.MemberTypes.complexProperty||a.kind==$data.MemberTypes.property&&!a.notMapped)c[a.computed?"_id":a.name]=b.physicalData[a.name]},this);return c},supportedDataTypes:{value:[$data.Integer,$data.String,$data.Number,$data.Blob,$data.Boolean,$data.Date,$data.ObjectID,$data.Object,$data.GeographyPoint,$data.Guid,$data.GeographyLineString,$data.GeographyPolygon,$data.GeographyMultiPoint,$data.GeographyMultiLineString,$data.GeographyMultiPolygon,$data.GeographyCollection,
$data.GeometryPoint,$data.GeometryLineString,$data.GeometryPolygon,$data.GeometryMultiPoint,$data.GeometryMultiLineString,$data.GeometryMultiPolygon,$data.GeometryCollection,$data.Byte,$data.SByte,$data.Decimal,$data.Float,$data.Int16,$data.Int32,$data.Int64,$data.Time,$data.DateTimeOffset],writable:!1},supportedBinaryOperators:{value:{equal:{mapTo:":",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},notEqual:{mapTo:"$ne",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},
equalTyped:{mapTo:":",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},notEqualTyped:{mapTo:"$ne",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},greaterThan:{mapTo:"$gt",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},greaterThanOrEqual:{mapTo:"$gte",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},lessThan:{mapTo:"$lt",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},lessThenOrEqual:{mapTo:"$lte",dataType:"boolean",
allowedIn:[$data.Expressions.FilterExpression]},or:{mapTo:"$or",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},and:{mapTo:"$and",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression]},"in":{mapTo:"$in",allowedIn:[$data.Expressions.FilterExpression]}}},supportedUnaryOperators:{value:{not:{mapTo:"$nor"}}},supportedFieldOperations:{value:{contains:{dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression],parameters:[{name:"substring",dataType:"string"}]},startsWith:{dataType:"string",
allowedIn:[$data.Expressions.FilterExpression],parameters:[{name:"@expression",dataType:"string"},{name:"strFragment",dataType:"string"}]},endsWith:{dataType:"string",allowedIn:[$data.Expressions.FilterExpression],parameters:[{name:"@expression",dataType:"string"},{name:"strFragment",dataType:"string"}]}},enumerable:!0,writable:!0},supportedSetOperations:{value:{filter:{},map:{},length:{},forEach:{},toArray:{},batchDelete:{},single:{},take:{},skip:{},orderBy:{},orderByDescending:{},first:{},include:{},
withInlineCount:{},some:{invokable:!1,allowedIn:[$data.Expressions.FilterExpression],parameters:[{name:"filter",dataType:"$data.Queryable"}],mapTo:"some",frameType:$data.Expressions.SomeExpression},every:{invokable:!1,allowedIn:[$data.Expressions.FilterExpression],parameters:[{name:"filter",dataType:"$data.Queryable"}],mapTo:"every",frameType:$data.Expressions.EveryExpression}},enumerable:!0,writable:!0},fieldConverter:{value:$data.mongoDBConverter}},{isSupported:{get:function(){return!$data.mongoDBDriver?
!1:!0},set:function(){}}});$data.storageProviders.mongoDB.mongoDBProvider.isSupported&&$data.StorageProviderBase.registerProvider("mongoDB",$data.storageProviders.mongoDB.mongoDBProvider);try{"undefined"===typeof navigator&&(navigator=window.navigator=require("navigator"))}catch(err$$1){}
