...
dataType:"$data.Queryable"}],mapTo:"all",frameType:$data.Expressions.EveryExpression},take:{},skip:{},orderBy:{},orderByDescending:{},first:{},include:{},batchDelete:{},withInlineCount:{}},enumerable:!0,writable:!0},fieldConverter:{value:$data.oDataConverter},resolveTypeOperations:function(a,b,c){var e=b.entityType.getMemberDefinition(a);(!e||!e.method||!1!==e.method.IsSideEffecting||!e.method.returnType||!(c===$data.Expressions.FilterExpression||c===$data.Expressions.OrderExpression))&&Guard.raise(new Exception("Entity '"+
...
e},this)||this.includes.push({name:e,type:d.ToType}):Guard.raise(new Exception("The given include path is invalid: "+a.selector.value+", invalid point: "+e)),d=this.mainEntitySet.entityContext._storageModel.getStorageModel(d.ToType)}},VisitProjectionExpression:function(a,b){this.Visit(a.source,b);Container.createoDataProjectionCompiler(this.context).compile(a,b)},VisitFilterExpression:function(a,b){this.Visit(a.source,b);var c=Container.createoDataWhereCompiler(this.provider);b.data="";c.compile(a.selector,
b);b.$filter=b.data;b.data=""},VisitInlineCountExpression:function(a,b){this.Visit(a.source,b);b.$inlinecount=a.selector.value},VisitEntitySetExpression:function(a,b){b.urlText+="/"+a.instance.tableName;if(a.params)for(var c=0;c<a.params.length;c++)this.Visit(a.params[c],b)},VisitServiceOperationExpression:function(a,b){a.boundItem&&(b.urlText+="/"+a.boundItem.entitySet.tableName,a.boundItem.data instanceof $data.Entity&&(b.urlText+="("+this.provider.getEntityKeysValue(a.boundItem)+")"));b.urlText+=
"/"+a.cfg.serviceName;b.method=b.method||a.cfg.method;if(a.params)for(var c=0;c<a.params.length;c++)this.Visit(a.params[c],b)},VisitBatchDeleteExpression:function(a,b){this.Visit(a.source,b);b.urlText+="/$batchDelete";b.method="DELETE"},VisitConstantExpression:function(a,b){var c=Container.resolveName(a.type);a.value instanceof $data.Entity&&(c=$data.Entity.fullName);var e=this.provider.fieldConverter.toDb[c],d=e?e(a.value):a.value;"GET"===b.method||!b.method?(d=(e=this.provider.fieldConverter.escape[c])?
